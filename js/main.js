...
function drawComparisonCanvas(canvasId, image, poseResults, color) {
    ...
    if (currentLayout === 'vertical') {
        ...
        // 各画像: 142mm x 190mm (3:4比率、92%使用で最大化)
        // 合計幅: 142mm * 2 + 10mm(gap) = 294mm → 実効170mmに収まるよう自動縮小
        // 画像エリア使用率: 190mm / 207mm = 92% (最小限の余白8%確保)
        maxWidth = 142 * 3.7795;   // 約536px (3:4比率の横幅、最大化)
        maxHeight = 190 * 3.7795;  // 約718px (3:4比率の縦幅、画像エリアの92%使用)
